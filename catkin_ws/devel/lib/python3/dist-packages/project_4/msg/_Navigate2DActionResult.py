...
"""autogenerated by genpy from project_4/Navigate2DActionResult.msg. Do not edit."""
import codecs
import sys
...
class Navigate2DActionResult(genpy.Message):
  ...
  _type = "project_4/Navigate2DActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','project_4/Navigate2DResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = project_4.msg.Navigate2DResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = project_4.msg.Navigate2DResult()
