...
// (in-package my_robot_tutorial.srv)
...
class OddEvenCheckRequest {
  ...
  static datatype() {
    ...
    return 'my_robot_tutorial/OddEvenCheckRequest';
  }
...
class OddEvenCheckResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'my_robot_tutorial/OddEvenCheckResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'my_robot_tutorial/OddEvenCheck'; }
};
