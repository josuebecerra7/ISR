...
(cl:defmethod cl:initialize-instance :after ((m <TurnCamera-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCamera-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project_3-srv:<TurnCamera-request> is deprecated: use project_3-srv:TurnCamera-request instead.")))

(cl:ensure-generic-function 'turn_degrees-val :lambda-list '(m))
(cl:defmethod turn_degrees-val ((m <TurnCamera-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_3-srv:turn_degrees-val is deprecated.  Use project_3-srv:turn_degrees instead.")
  (turn_degrees m))
...
(cl:defmethod cl:initialize-instance :after ((m <TurnCamera-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TurnCamera-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project_3-srv:<TurnCamera-response> is deprecated: use project_3-srv:TurnCamera-response instead.")))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <TurnCamera-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_3-srv:image-val is deprecated.  Use project_3-srv:image instead.")
  (image m))
