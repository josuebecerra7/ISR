...
(cl:defmethod cl:initialize-instance :after ((m <Navigate2DFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Navigate2DFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project_4-msg:<Navigate2DFeedback> is deprecated: use project_4-msg:Navigate2DFeedback instead.")))

(cl:ensure-generic-function 'distance_to_point-val :lambda-list '(m))
(cl:defmethod distance_to_point-val ((m <Navigate2DFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_4-msg:distance_to_point-val is deprecated.  Use project_4-msg:distance_to_point instead.")
  (distance_to_point m))
