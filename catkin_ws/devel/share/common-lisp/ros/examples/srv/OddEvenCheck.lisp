...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name examples-srv:<OddEvenCheck-request> is deprecated: use examples-srv:OddEvenCheck-request instead.")))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <OddEvenCheck-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader examples-srv:number-val is deprecated.  Use examples-srv:number instead.")
  (number m))
...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name examples-srv:<OddEvenCheck-response> is deprecated: use examples-srv:OddEvenCheck-response instead.")))

(cl:ensure-generic-function 'answer-val :lambda-list '(m))
(cl:defmethod answer-val ((m <OddEvenCheck-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader examples-srv:answer-val is deprecated.  Use examples-srv:answer instead.")
  (answer m))
