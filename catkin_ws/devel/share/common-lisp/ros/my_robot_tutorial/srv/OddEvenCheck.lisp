...
(cl:in-package my_robot_tutorial-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_tutorial-srv:<OddEvenCheck-request> is deprecated: use my_robot_tutorial-srv:OddEvenCheck-request instead.")))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <OddEvenCheck-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_tutorial-srv:number-val is deprecated.  Use my_robot_tutorial-srv:number instead.")
  (number m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OddEvenCheck-request>)))
  ...
  "my_robot_tutorial/OddEvenCheckRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OddEvenCheck-request)))
  "Returns string type for a service object of type 'OddEvenCheck-request"
  "my_robot_tutorial/OddEvenCheckRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_tutorial-srv:<OddEvenCheck-response> is deprecated: use my_robot_tutorial-srv:OddEvenCheck-response instead.")))

(cl:ensure-generic-function 'answer-val :lambda-list '(m))
(cl:defmethod answer-val ((m <OddEvenCheck-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_tutorial-srv:answer-val is deprecated.  Use my_robot_tutorial-srv:answer instead.")
  (answer m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OddEvenCheck-response>)))
  ...
  "my_robot_tutorial/OddEvenCheckResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OddEvenCheck-response)))
  "Returns string type for a service object of type 'OddEvenCheck-response"
  "my_robot_tutorial/OddEvenCheckResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OddEvenCheck)))
  ...
  "my_robot_tutorial/OddEvenCheck")