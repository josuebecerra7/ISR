...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project_1-srv:<OddEvenCheck-request> is deprecated: use project_1-srv:OddEvenCheck-request instead.")))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <OddEvenCheck-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_1-srv:number-val is deprecated.  Use project_1-srv:number instead.")
  (number m))
...
(cl:defmethod cl:initialize-instance :after ((m <OddEvenCheck-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OddEvenCheck-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name project_1-srv:<OddEvenCheck-response> is deprecated: use project_1-srv:OddEvenCheck-response instead.")))

(cl:ensure-generic-function 'answer-val :lambda-list '(m))
(cl:defmethod answer-val ((m <OddEvenCheck-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader project_1-srv:answer-val is deprecated.  Use project_1-srv:answer instead.")
  (answer m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OddEvenCheck-response>)))
  ...
  "project_1/OddEvenCheckResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OddEvenCheck-response)))
  "Returns string type for a service object of type 'OddEvenCheck-response"
  "project_1/OddEvenCheckResponse")
